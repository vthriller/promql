...
pub(crate) fn surrounded_ws<I, Item, O, P: FnMut(I) -> IResult<I, O>>(parser: P) -> impl FnMut(I) -> IResult<I, O>
where
...
*/
pub(crate) fn delimited_ws<I, Item, O1, O2, O3, P1, P2, P3>(p1: P1, p2: P2, p3: P3) -> impl FnMut(I) -> IResult<I, O2>
where
